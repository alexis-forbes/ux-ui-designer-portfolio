...
import featuresDetails from "../../data/sections/project-details-cinemaz-takeaway.json";

const ProjectDetailsCinemazTakaway = () => {
    return (
...
export default ProjectDetailsCinemazTakaway;
